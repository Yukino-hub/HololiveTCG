document.addEventListener('DOMContentLoaded', function() {
    ...
    function getImageUrl(card) {
        return constructImageUrl(card, {
            showSigned: signedCheckbox.checked,
            showHolomenRare: holomenRareCheckbox.checked,
            showFullArt: fullArtCheckbox.checked,
            showAltArt: altArtCheckbox.checked,
            showFoil: foilCheckbox.checked,
            showGrandPrix: grandprixCheckbox.checked
        });
    }
